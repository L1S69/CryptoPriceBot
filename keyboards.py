...
def create_keyboard(cols: int, buttons: List[str]):
    keyboard = telebot.types.ReplyKeyboardMarkup(row_width=cols, resize_keyboard=True) # Create a new instance of ReplyKeyboardMarkup with given number of columns and ability to resize
